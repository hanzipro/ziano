...
export const PLAY_ALL_BODY = [
  '<p>清晨，我坐在這架字體鋼琴前，想把一百二十枚琴鍵逐一按響。每一枚切片都是一個音，藏在傳承字形的骨架裡。指尖落下，戶的點、骨的折、青的底、過的走之，逐一亮起。從台北到倫敦，由鉛字到螢幕，書寫不斷改變，對美的講究始終如一；橫豎撇捺之間，載著前人的情感與溫度，言語靜靜流動，從不間斷——這架琴奏的，正是一闋無聲之\uf914。</p>',
